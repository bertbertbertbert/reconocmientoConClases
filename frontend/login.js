...
form.addEventListener("submit", async (e) => {
    ...
    if (data.ok) {
        ...
        document.getElementById('biometria').style.display = 'block';
         ...
         validacionBiometrica(data.usuario);
...
const validacionBiometrica = (usuario)=>{
...
// Conectar WebSocket
const ws = new WebSocket(`ws://localhost:8000/ws?usuario=${usuario}`); //websocket protocol que manté la conexió oberta 

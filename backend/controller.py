        ...
        try:
            while True:
                ...
                if tiempo_transcurrido >= 1.0:
                    es.fps_real = es.contador / tiempo_transcurrido
                ...
                match num_caras:
                    ...
                    case 1:
                        ...
                        if not es.usuario_encontrado and (es.contador % PROCESAR_CADA_N_FRAMES == 0):
                    ...
                    case _:
                        ...
                        if es.contador % PROCESAR_CADA_N_FRAMES == 0:
